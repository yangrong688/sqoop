...
public class PostgresqlTestUtil {
  ...
  public static final String TABLE_NAME = "EMPLOYEES_PG";

  public static final String NULL_TABLE_NAME = "NULL_EMPLOYEES_PG";

  public static final String SPECIAL_TABLE_NAME = "EMPLOYEES_PG's";

  public static final String DIFFERENT_TABLE_NAME = "DIFFERENT_TABLE";
