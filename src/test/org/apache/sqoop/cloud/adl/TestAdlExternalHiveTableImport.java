...
public class TestAdlExternalHiveTableImport extends AbstractTestExternalHiveTableImport {

  @ClassRule
  public static AdlCredentialsRule credentialsRule = new AdlCredentialsRule();

  public TestAdlExternalHiveTableImport(String fileFormatArg, List<String> expectedResult) {
